...
export const Header: React.FC = () => {
  ...
  return (
    <header className="h-16 bg-green-900 border-b shadow-lg border-gray-200 fixed top-0 right-0 left-64 z-10">
      <div className="h-full px-6 flex items-center justify-end">
        ...
        <div className="relative">
          ...
          {showNotifications && (
            <div className="absolute right-0 mt-2 w-80 bg-green-100 rounded-lg shadow-lg border border-gray-200">
        ...
        <div className="relative ml-4">
          <button
            ...
            className="flex items-center space-x-2 text-green-100 hover:bg-green-100 hover:text-green-900 rounded-lg p-2"
          >
          ...
          {showProfileMenu && (
            <div className="absolute right-0 mt-2 w-48 bg-green-100 rounded-lg shadow-lg border border-gray-200">
              <div className="py-1">
